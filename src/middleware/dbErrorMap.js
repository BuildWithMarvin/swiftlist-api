export const dbErrorMap = {
  'ER_BAD_NULL_ERROR': { message: "Required fields are missing.", statusCode: 400 },
  'ER_DATA_TOO_LONG': { message: "Title or description is too long.", statusCode: 400 },
...
export function handleDbError(err) {
  ...
  const errorMessage = mappedError ? mappedError.message : "The service is temporarily unavailable.";
